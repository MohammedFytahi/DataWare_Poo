...
try {
    $connection = new PDO("mysql:host=localhost;dbname=dataware", "root", "", $pdoOptions);
...
$owner = new Owner($nom, $prenom, $email, $tel, $role, $equipe, $statut, $connection);

$teams = $owner->getAllTeams();
?>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        <?php foreach ($teams as $team) : ?>
            <div class="bg-white p-4 rounded-md shadow-md">
                <strong class="block text-xl font-semibold mb-2"><?php echo $team->getNomEquipe(); ?></strong>
                <p class="text-gray-700"><?php echo $team->getDescription(); ?></p>
                <p class="text-gray-600 mt-2">Date de création: <?php echo $team->getCreationDate(); ?></p>
            </div>
        <?php endforeach; ?>
    </div>
</div>
