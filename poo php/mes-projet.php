...
// Passer la connexion à la classe Membre
$membre = new Membre($database);

// Appel de la méthode pour obtenir les projets du membre
$memberProjects = $membre->getMemberProjects($membreId);
?>
...
<nav class="bg-gray-800">
      ...
      <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
        ...
        <div class="hidden sm:ml-6 sm:block">
          <div class="flex space-x-4">
            ...
            <a href="mes-equipes.php" class="bg-gray-900 text-white rounded-md px-3 py-2 text-sm font-medium" aria-current="page">Membres</a>
  ...
  <div class="sm:hidden" id="mobile-menu">
    ...
    <h1 class="text-center mt-5 mb-5 text-3xl font-bold">Mes Projets</h1>
    
    <div class="container mx-auto mt-4">
        <div class="shadow-lg overflow-x-auto">
            <table class="min-w-full bg-primary mt-4 table-auto">
                <thead>
                    <tr>
                        <th class="py-2 px-4 text-light">Nom du projet</th>
                        <th class="py-2 px-4 text-light">Date début</th>
                        <th class="py-2 px-4 text-light">Date fin</th>
                        <th class="py-2 px-4 text-light">Status</th>
                    </tr>
                </thead>
                <?php
                if (empty($memberProjects)) {
                    $message = "<span class='text-red-500'>Il n'y a pas encore de projets.</span>";
                } else {
                    foreach ($memberProjects as $project) {
                ?>
                        <tbody class="table-light">
                            <tr>
                                <td class="py-2 px-4"><?= $project['nom_projet']; ?></td>
                                <td class="py-2 px-4"><?= $project['date_debut']; ?></td>
                                <td class="py-2 px-4"><?= $project['date_fin']; ?></td>
                                <td class="py-2 px-4"><?= $project['statut']; ?></td>
                            </tr>
                        </tbody>
                <?php
                    }
